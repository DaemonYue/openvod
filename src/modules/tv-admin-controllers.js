            ...
            function ($scope, $state, $http, $stateParams, $location, util, CONFIG) {
                ...
                $scope.my_tree_handler = function (branch) {
                    ...
                    if (branch.data.type == 'SimpleSmallPicText') {
                        $state.go('app.tvAdmin.SimpleSmallPicText', {
                    ...
                    if (branch.data.type == 'Yeste_SimpleSmallPicText') {
                        $state.go('app.tvAdmin.Yeste_SimpleSmallPicText', {
                            moduleId: branch.data.moduleId,
                            label: branch.label
                        });
                        self.changeMenuInfo();
                    ...
                    if (branch.data.type == 'Yeste_SimpleSmallPicText_Carousel') {
                        $state.go('app.tvAdmin.Yeste_SimpleSmallPicText_Carousel', {
                            moduleId: branch.data.moduleId,
                            label: branch.label
                        });
                        self.changeMenuInfo();
                    ...
                    if (branch.data.type == 'SiMaTai_SimpleSmallPicText') {
                        $state.go('app.tvAdmin.SiMaTai_SimpleSmallPicText', {
                            moduleId: branch.data.moduleId,
                            label: branch.label
                        });
                        self.changeMenuInfo();
                    ...
                    if (branch.data.type == 'SiMaTai_PicText_Classification') {
                        $state.go('app.tvAdmin.SiMaTai_PicText_Classification', {
                            moduleId: branch.data.moduleId,
                            label: branch.label
                        });
                        self.changeMenuInfo();
                    ...
                    if (branch.data.type == 'SiMaTai_PicText_Classification_ThreeLevel') {
                        $state.go('app.tvAdmin.SiMaTai_PicText_Classification_ThreeLevel', {
                            moduleId: branch.data.moduleId,
                            label: branch.label
                        });
                        self.changeMenuInfo();
                    ...
                    if (branch.data.type == 'Samsung_PicText_Classification') {
                        $state.go('app.tvAdmin.Samsung_PicText_Classification', {
                            moduleId: branch.data.moduleId,
                            label: branch.label
                        });
                        self.changeMenuInfo();
                    ...
                    //三星退房
                    if (branch.data.type == 'Samsung_MultPic_OutOfTheHotel') {

                        $state.go('app.tvAdmin.Samsung_MultPic_OutOfTheHotel', {
                            moduleId: branch.data.moduleId,
                            label: branch.label
                        });
                        self.changeMenuInfo();
                    ...
                    //三星航班
                    if (branch.data.type == 'Samsung_MultPic_Flight') {

                        $state.go('app.tvAdmin.Samsung_MultPic_Flight', {
                            moduleId: branch.data.moduleId,
                            label: branch.label
                        });
                        self.changeMenuInfo();
                    ...
                    if (branch.data.type == 'Samsung_Link_Bill') {
                        ...
                        $state.go('app.tvAdmin.Samsung_Link_Bill', {
                            moduleId: branch.data.moduleId,
                            label: branch.label
                        });
                        self.changeMenuInfo();
                    ...
                    if (branch.data.type == 'LiFeng_SimpleSmallPicText') {
                        ...
                        $state.go('app.tvAdmin.SimpleSmallPicText_LiFeng', {
                            moduleId: branch.data.moduleId,
                            label: branch.label
                        });
                        self.changeMenuInfo();
                    ...
                    if (branch.data.type == 'LiFeng_SimpleSmallPicText_Left') {
                        $state.go('app.tvAdmin.LiFeng_SimpleSmallPicText_Left', {
                            moduleId: branch.data.moduleId,
                            label: branch.label
                        });
                        self.changeMenuInfo();
                    ...
                    if (branch.data.type == 'ZheFei_SimpleSmallPicText_Carousel') {
                        $state.go('app.tvAdmin.ZheFei_SimpleSmallPicText_Carousel', {
                            moduleId: branch.data.moduleId,
                            label: branch.label
                        });
                        self.changeMenuInfo();
                    ...
                    if (branch.data.type == 'ZheFei_SimpleSmallPicText_Small') {
                        //  type的名字 和 state 的名字 不一样，下次要起好
                        $state.go('app.tvAdmin.ZheFei_SimpleSmallPicText_Small', {
                            moduleId: branch.data.moduleId,
                            label: branch.label
                        });
                        self.changeMenuInfo();
                    ...
                    if (branch.data.type == 'PicText_Classification') {
                        $state.go('app.tvAdmin.PicText_Classification', {
                            moduleId: branch.data.moduleId,
                            label: branch.label
                        });
                        self.changeMenuInfo();
                    ...
                    if (branch.data.type == 'MultPic_SX_Small') {
                        $state.go('app.tvAdmin.MultPic_SX_Small', {
                            moduleId: branch.data.moduleId,
                            label: branch.label
                        });
                        self.changeMenuInfo();
                    ...
                    if (branch.data.type == 'SimplePicText_Price') {
                        $state.go('app.tvAdmin.SimplePicText_Price', {
                            moduleId: branch.data.moduleId,
                            label: branch.label
                        });
                        self.changeMenuInfo();
                    ...
                    if (branch.data.type == 'SimplePicText_SX') {
                        $state.go('app.tvAdmin.SimplePicText_SX', {
                            moduleId: branch.data.moduleId,
                            label: branch.label
                        });
                        self.changeMenuInfo();
                    ...
                    if (branch.data.type == 'PicText_Classification_SX') {
                        $state.go('app.tvAdmin.PicText_Classification_SX', {
                            moduleId: branch.data.moduleId,
                            label: branch.label
                        });
                        self.changeMenuInfo();
                    ...
                    if (branch.data.type == 'ZheFei_PicText_Classification') {
                        // type 和 state 的名字不一样
                        $state.go('app.tvAdmin.ZheFei_PicText_Classification', {
                            moduleId: branch.data.moduleId,
                            label: branch.label
                        });
                        self.changeMenuInfo();
                    ...
                    if (branch.data.type == 'Yeste_WorldClock') {
                        $state.go('app.tvAdmin.Yeste_WorldClock', {
                            moduleId: branch.data.moduleId,
                            label: branch.label
                        });
                        self.changeMenuInfo();
                    ...
                    if (branch.data.type == 'Hospital_Section_PersonalInfo_Nurse') {
                        ...
                        $state.go('app.tvAdmin.NurseInfo', {
                            moduleId: branch.data.moduleId,
                            label: branch.label,
                            type: branch.data.showType
                        });
                        self.changeMenuInfo();
                    }
                    ...
                    if (branch.data.type == 'Hospital_Section_PersonalInfo_Expert') {
                        ...
                        $state.go('app.tvAdmin.ExpertInfo', {
                            moduleId: branch.data.moduleId,
                            label: branch.label,
                            type: branch.data.showType
                        });
                    ...
                    if (branch.data.type == 'Hospital_Guide_RehabilitationDistrict') {
                        ...
                        $state.go('app.tvAdmin.RehabilitationDistrict', {
                            moduleId: branch.data.moduleId,
                            label: branch.label
                        });
                        self.changeMenuInfo();
                    ...
                    //DiseaseIntroduction
                    if (branch.data.type == 'Hospital_Disease_Science') {

                        $state.go('app.tvAdmin.DiseaseScience', {moduleId: branch.data.moduleId, label: branch.label});
                        self.changeMenuInfo();
                    }

                    //RecommendedDiet
                    if (branch.data.type == 'Hospital_Recommended_Diet') {

                        $state.go('app.tvAdmin.RecommendDiet', {moduleId: branch.data.moduleId, label: branch.label});
                        self.changeMenuInfo();
                    }

                    //DischargeGuide
                    if (branch.data.type == 'Hospital_Discharge_Guide') {

                        $state.go('app.tvAdmin.DischargeGuide', {moduleId: branch.data.moduleId, label: branch.label});
                        self.changeMenuInfo();
                    }
                    ...
                    if (branch.data.type == 'MainMenu_THJ_SecondMenu'
                        ...
                        || branch.data.type == 'Hospital_MainMenuB') {
                        $state.go('app.tvAdmin.blank', {label: branch.label});
                        self.changeMenuInfo();
                    }
                ...
                self.changeMenuInfo = function () {
                    ...
                    // 以上
                    self.imgs3 = new Imgs([{
                        "ImageURL": my_tree.get_selected_branch().data.img,
                        "ImageSize": my_tree.get_selected_branch().data.imgSize
                    }], true);
                    self.imgs3.initImgs();
                    self.imgs4 = new Imgs([{
                        "ImageURL": my_tree.get_selected_branch().data.focusImg,
                        "ImageSize": my_tree.get_selected_branch().data.focusImgSize
                    }], true);
                    self.imgs4.initImgs();
                ...
                self.getWelInfo = function () {
                    ...
                    $http({
                        ...
                        if (data.rescode == '200') {
                            ...
                            //通告
                            self.Announcement = data.data.Announcement;
                            ...
                            if (data.data.BackgroundVideoURL) {
                                self.imgs3 = new Imgs([{
                                    "ImageURL": data.data.BackgroundVideoURL,
                                    "ImageSize": data.data.BackgroundVideoSize
                                }], true);
                                self.imgs3.initImgs();
                            }
                            else {
        ...
        .controller('tvCheckOutPicSamsangController', ['$scope', '$state', '$http', '$stateParams', '$location', 'util',
            function ($scope, $state, $http, $stateParams, $location, util) {
                ...
                self.edit = function (index) {
                    $scope.app.maskParams.viewId = self.viewId;
                    $scope.app.maskParams.picInfo = self.pics[index];
                    $scope.app.showHideMask(true, 'pages/tv/onePicEdit.html');
                }
                ...
                self.add = function () {
                    $scope.app.maskParams.viewId = self.viewId;
                    $scope.app.showHideMask(true, 'pages/tv/onePicAdd.html');
                }
        ...
        .controller('tvOnePicAddController', ['$scope', '$state', '$http', '$stateParams', '$location', 'util', 'CONFIG',
            function ($scope, $state, $http, $stateParams, $location, util, CONFIG) {
                ...
                self.init = function () {
                    ...
                    // 获取编辑多语言信息
                    self.editLangs2 = util.getParams('editLangs');
                    self.editLangs = [];
                    self.editLangs.push(self.editLangs2[0]);
                    self.defaultLangCode = util.getDefaultLangCode();
        ...
        .controller('tvFlightSamsangController', ['$scope', '$state', '$http', '$stateParams', '$location', 'util',
            function ($scope, $state, $http, $stateParams, $location, util) {
                ...
                self.edit = function (index) {
                    $scope.app.maskParams.viewId = self.viewId;
                    $scope.app.maskParams.picInfo = self.pics[index];
                    $scope.app.showHideMask(true, 'pages/tv/flightPicEdit_Samsung.html');
                }
                ...
                self.add = function () {
                    $scope.app.maskParams.viewId = self.viewId;
                    $scope.app.showHideMask(true, 'pages/tv/flightPicAdd_Samsung.html');
                }
        ...
        .controller('tvLiveEditController', ['$scope', '$state', '$http', '$stateParams', '$location', 'util', 'CONFIG',
            function ($scope, $state, $http, $stateParams, $location, util, CONFIG) {
                ...
                self.setInfo = function () {
                    ...
                    self.imgs1 = new Imgs([{
                        "ImageURL": self.liveInfo.ChannelPicURL,
                        "ImageSize": self.liveInfo.ChannelPicSize
                    }], true);
                    self.imgs1.initImgs();
                }
        ...
        .controller('tvCatTextListController', ['$scope', '$state', '$http', '$stateParams', '$location', 'util',
            function ($scope, $state, $http, $stateParams, $location, util) {
                ...
                self.editCate = function () {
                    ...
                    $scope.app.maskParams.info = self.info[self.cateIndex];
                    $scope.app.maskParams.loadInfo = self.loadInfo;
                    $scope.app.showHideMask(true, 'pages/tv/categoryText_DI_CatEdit.html');
                }
                ...
                self.editPic = function (index) {
                    ...
                    $scope.app.maskParams.info = self.info[self.cateIndex].sub[index];
                    $scope.app.maskParams.loadInfo = self.loadInfo;
                    $scope.app.showHideMask(true, 'pages/tv/categoryText_DI_TextEdit.html');
                }
                ...
                self.addPic = function () {
                    ...
                    $scope.app.maskParams.cateId = self.info[self.cateIndex].ID;
                    $scope.app.maskParams.loadInfo = self.loadInfo;
                    $scope.app.showHideMask(true, 'pages/tv/categoryText_DI_TextAdd.html');
                }
        ...
        .controller('tvCategoryPicListController', ['$scope', '$state', '$http', '$stateParams', '$location', 'util',
            function ($scope, $state, $http, $stateParams, $location, util) {
                ...
                self.addCategory = function () {
                    $scope.app.maskParams.viewId = self.viewId;
                    $scope.app.maskParams.loadInfo = self.loadInfo;
                    $scope.app.showHideMask(true, 'pages/tv/categoryPic_Guide_CatAdd.html');
                }
                ...
                self.editCate = function () {
                    ...
                    $scope.app.maskParams.info = self.info[self.cateIndex];
                    $scope.app.maskParams.loadInfo = self.loadInfo;
                    $scope.app.showHideMask(true, 'pages/tv/categoryPic_Guide_CatEdit.html');
                }
                ...
                self.editPic = function (index) {
                    ...
                    $scope.app.maskParams.info = self.info[self.cateIndex].sub[index];
                    $scope.app.maskParams.loadInfo = self.loadInfo;
                    $scope.app.showHideMask(true, 'pages/tv/categoryPic_Guide_PicEdit.html');
                }
                ...
                self.addPic = function () {
                    ...
                    $scope.app.maskParams.cateId = self.info[self.cateIndex].ID;
                    $scope.app.maskParams.loadInfo = self.loadInfo;
                    $scope.app.showHideMask(true, 'pages/tv/categoryPic_Guide_PicAdd.html');
                }
